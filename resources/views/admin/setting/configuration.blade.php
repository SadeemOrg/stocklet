                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="language_status" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if ($general->language_status) checked @endif>
                                </div>
                            </li>
