@php
    ...
    if (@$image) {
        $url = route('admin.images.update', $image->id);
    }
@endphp
                ...
                <form action="{{ $url }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row g-0">
                            <div class="col-md-6 mb-3">
                                <div class="photo-upload-area">
                                    <div class="file-upload">
                                        ...
                                        <button class="base-btn w-100 mt-3 btn btn--primary box--shadow1 upload-btn" type="button">@lang('Add Image')</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="form--select">
                                            <select class="form-select" name="category" required>
                                                <option value="">@lang('Select One Category')</option>
                            ...
                            <div class="col-12">
                                <button type="submit" class="base-btn w-100 mt-3 btn btn--primary box--shadow1 ">@lang('Submit')</button>
                            </div>
                        </div>
                    </div>
                </form>
