    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.image') }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.video') }}">
                    <a  href="{{ route('admin.videos.list') }}" class="nav-link ">
                        <i class="menu-icon las la-film"></i>
                        <span class="menu-title">@lang('Manage video')</span>
                    </a>
                </li>
                @if (false)
                                ...
                                <li class="sidebar-menu-item {{ menuActive('admin.images.pending') }} ">
                                    <a href="{{ route('admin.images.pending') }}" class="nav-link">
                                        ...
                                        @if ($pendingImagesCount)
                                            <span
                                                class="menu-badge pill bg--danger ms-auto">{{ $pendingImagesCount }}</span>
                                        @endif
                                    </a>
                                </li>
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown">
                        <a href="javascript:void(0)" class="{{ menuActive('admin.videos*', 3) }}">
                            <i class="menu-icon las la-film"></i>
                        ...
                        <div class="sidebar-submenu {{ menuActive('admin.video*', 2) }} ">
                            <ul>
                                <li class="sidebar-menu-item {{ menuActive('admin.videos.pending') }} ">
                                    <a href="{{ route('admin.videos.pending') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Pending video')</span>
                                        @if ($pendingImagesCount)
                                            <span
                                                class="menu-badge pill bg--danger ms-auto">{{ $pendingImagesCount }}</span>
                                        @endif
                                ...
                                <li class="sidebar-menu-item {{ menuActive('admin.videos.rejected') }} ">
                                    <a href="{{ route('admin.videos.rejected') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Rejected video')</span>
                                    </a>
                                </li>

                                <li class="sidebar-menu-item {{ menuActive('admin.videos.approved') }} ">
                                    <a href="{{ route('admin.videos.approved') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Approved video')</span>
                                    </a>
                                </li>
                                ...
                                <li class="sidebar-menu-item {{ menuActive('admin.videos.all') }} ">
                                    <a href="{{ route('admin.videos.all') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('All video')</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
