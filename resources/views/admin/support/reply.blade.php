                ...
                <div class="card-body ">
                    ...
                    <h6 class="card-title  mb-4">
                        <div class="row">
                            ...
                            <div class="col-sm-4  col-md-6 {{app()->getLocale() === 'ar' ? 'text-sm-start' : 'text-sm-end'}} mt-sm-0 mt-3">
                    ...
                    <form action="{{ route('admin.ticket.reply', $ticket->id) }}" enctype="multipart/form-data" method="post" class="form-horizontal">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 {{app()->getLocale() === 'ar' ? 'offset-md-3' : ''}}">
                                <div class="row form-group">
                                    <div class="col-12 mb-4">
                                        <label for="inputAttachments"><b> @lang('Attachments')</b></label> <br> <span class="text--danger">@lang('Max 5 files can be uploaded. Maximum upload size is') {{ ini_get('upload_max_filesize') }}</span>
                                    </div>
                                    <div class="col-9">
                            ...
                            <div class="col-md-3 {{app()->getLocale() === 'ar' ? '' : 'offset-md-3'}}">
                    ...
                    @foreach ($messages as $message)
                        @if ($message->admin_id == 0)
                            <div class="row border border--primary border-radius-3 my-3 mx-2">
                                ...
                                <div class="col-md-3 {{app()->getLocale() === 'ar' ? 'border-start' : 'border-end'}} text-md-end text-start">
