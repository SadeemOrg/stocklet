    ...
    <div class="container custom--container">
        <div class="header-primary__content">
            ...
            <div class="collapse navbar-collapse" id="navbarToggle">
                <div class="nav-container d-lg-flex justify-content-between">
                    <ul class="list primary-menu mr-4">
                    ...
                    <ul class="list primary-menu pb-2 pb-md-0">
                        ...
                        @else
                            <li class="nav-item">
                                <a href="{{ route('user.login') }}" class="btn btn--lg rounded-3 signup-btn--dark">@lang('Login')</a>
                            </li>
                            <li class="nav-item py-2">
                                <a href="{{ route('user.register') }}" class="btn btn--lg rounded-3 btn--base">@lang('Create Account')</a>
                            </li>
                        @endauth
                    </ul>
                </div>
