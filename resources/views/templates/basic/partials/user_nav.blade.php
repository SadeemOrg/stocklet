        ...
        <div class="dashboard-menu__body" data-simplebar>
            <div class="profile">
                ...
                <div class="profile__user">
                    <img src="{{ getImage(getFilePath('userProfile') . '/' . $user->image, null, 'user') }}"
                        alt="@lang('image')" class="profile__img" id="showProfileImage">
                </div>
            </div>
            <ul class="list dashboard-menu__list">
                ...
                <li>
                    <a href="{{ route('user.download.history') }}"
                        class="dashboard-menu__link {{ menuActive('user.download.history') }}">
                        <span class="dashboard-menu__icon">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#imageCollapse" aria-expanded="false">
                            ...
                            <div id="imageCollapse" class="accordion-collapse collapse" data-bs-parent="#images">
                                <div class="accordion-body">
                                    <ul class="list dashboard-menu__inner">
                                        <li>
                                            <a href="{{ route('user.image.pending') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.image.pending') }}">
                                                @lang('Pending images')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.image.rejected') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.image.rejected') }}">
                                                @lang('Rejected images')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.image.approved') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.image.approved') }}">
                                                @lang('Approved images')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.image.all') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.image.all') }}">
                                                @lang('All images')
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="accordion-button__text"> @lang('Manage video') </span>
                                </button>
                            </h2>
                            <div id="videoCollapse" class="accordion-collapse collapse" data-bs-parent="#video">
                                <div class="accordion-body">
                                    <ul class="list dashboard-menu__inner">
                                        <li>
                                            <a href="{{ route('user.video.pending') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.image.pending') }}">
                                                @lang('Pending video')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.video.rejected') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.image.rejected') }}">
                                                @lang('Rejected video')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.video.approved') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.image.approved') }}">
                                                @lang('Approved video')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.video.all') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.image.all') }}">
                                                @lang('All video')
                                            </a>
                                        </li>
                                    ...
                                    <ul class="list dashboard-menu__inner">
                                        <li>
                                            <a href="{{ route('user.deposit.index') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.deposit.index') }}">
                                                @lang('Deposit')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.deposit.history') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.deposit.history') }}">
                                                @lang('Deposit History')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.withdraw') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.withdraw') }}">
                                                @lang('Withdraw')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.withdraw.history') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.withdraw.history') }}">
                                                @lang('Withdraw History')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.transactions') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.transactions') }}">
                                                @lang('Transactions')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.earning.log') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.earning.log') }}">
                                                @lang('Earning Logs')
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <li>
                        <div class="accordion" id="referrals">
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#referral" aria-expanded="false">
                                        <span class="accordion-button__icon">
                                ...
                                <div id="referral" class="accordion-collapse collapse" data-bs-parent="#referrals">
                                    <div class="accordion-body">
                                        <ul class="list dashboard-menu__inner">
                                            <li>
                                                <a href="{{ route('user.referral.all') }}"
                                                    class="dashboard-menu__inner-link {{ menuActive('user.referral.all') }}">
                                                    @lang('Referrals')
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('user.referral.log') }}"
                                                    class="dashboard-menu__inner-link {{ menuActive('user.referral.log') }}">
                                                    @lang('Referral Log')
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <ul class="list dashboard-menu__inner">
                                        <li>
                                            <a href="{{ route('ticket.index') }}"
                                                class="dashboard-menu__inner-link {{ menuActive(['ticket.index', 'ticket.open', 'ticket.view']) }}">
                                                @lang('Support Tickets')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('member.images', $user->username) }}"
                                                class="dashboard-menu__inner-link">
                                                @lang('Profile Settings')
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.change.password') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.change.password') }}">
                                                @lang('Change Password')
                                            </a>
                                        </li>
                                        {{-- <li>
                                            <a href="{{ route('user.twofactor') }}"
                                                class="dashboard-menu__inner-link {{ menuActive('user.twofactor') }}">
                                                @lang('2FA Security')
                                            </a>
                                        </li> --}}
                                    </ul>
