@php
    ...
    $url = route('user.video.store');
    if (@$video) {
        // dd($video);
        $url = route('user.video.update',  $video->id);
    }
@endphp
...
@section('content')
                                ...
                                <div class="photo-upload-area">
                                    <div class="file-upload">
                                        ...
                                        <div class="file-upload-content @if (@$video) d-block @endif">
                                                                                       <video class="file-upload-image" controls src="{{ @$video ? URL::asset('/videos/'.$video->thumb) : '' }}"
    poster="benefits-of-coding.jpg"></video>
                                        ...
                                        <button class="base-btn w-100 mt-3 upload-btn"
                                    ...
                                    <div class="col-12 mb-3 price-div">
                                        ...
                                        <div class="input-group input--group">
                                            <input type="number" step="any" min="0" name="price"
                                                class="form-control form--control image-price"
