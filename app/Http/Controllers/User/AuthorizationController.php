...
class AuthorizationController extends Controller
{
    ...
    public function sendVerifyCode($type)
    {
        ...
        if ($this->checkCodeValidity($user)) {
            ...
            throw ValidationException::withMessages(['resend' => 'الرجاء المحاولة بعد ' . $delay . ' ثوان']);
        }
        ...
        $notify[] = ['success', 'تم إرسال رمز التحقق بنجاح'];
    ...
    public function emailVerification(Request $request)
    {
        ...
        throw ValidationException::withMessages(['code' => 'رمز التحقق لم يتطابق!']);
    }
