...
class LanguageController extends Controller
{
    ...
    public function langStore(Request $request)
    {
        ...
        $notify[] = ['success', 'أضافت اللغة بنجاح'];
    ...
    public function langUpdate(Request $request, $id)
    {
        ...
        if (!$request->is_default) {
            ...
            if (!$defaultLang) {
                $notify[] = ['error','يمكنك تعيين لغة أخرى على أنها افتراضية قبل إلغاء ضبط هذا'];
                return back()->withNotify($notify);
            }
        }
    ...
    public function langDelete($id)
    {
        ...
        $lang->delete();
        $notify[] = ['success', 'تم حذف اللغة بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function langEdit($id)
    {
        ...
        if (empty($json)) {
            $notify[] = ['error', 'لم يتم العثور على الملف'];
            return back()->withNotify($notify);
        }
    ...
    public function storeLanguageJson(Request $request, $id)
    {
        ...
        if (array_key_exists($reqKey, json_decode($items, true))) {
            $notify[] = ['error', "المفتاح موجود بالفعل"];
            return back()->withNotify($notify);
        } else {
            ...
            $notify[] = ['success', "تمت إضافة مفتاح اللغة بنجاح"];
            return back()->withNotify($notify);
        }
    ...
    public function deleteLanguageJson(Request $request, $id)
    {
        ...
        $notify[] = ['success', "تم حذف مفتاح اللغة بنجاح"];
        return back()->withNotify($notify);
    }
    public function updateLanguageJson(Request $request, $id)
    {
        ...
        $notify[] = ['success', 'تم تحديث مفتاح اللغة بنجاح'];
        return back()->withNotify($notify);
    }
