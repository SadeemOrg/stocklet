...
class NotificationController extends Controller
{
    ...
    public function globalUpdate(Request $request)
    {
        ...
        $notify[] = ['success', 'تحديث إعدادات الإخطار العالمية بنجاح'];
    ...
    public function templateUpdate(Request $request, $id)
    {
        ...
        $notify[] = ['success', 'تم تحديث قالب الإخطار بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'تحديث إعدادات البريد الإلكتروني بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function emailTest(Request $request)
    {
        ...
        if ($general->en) {
            ...
            $notify[] = ['info', 'يرجى تمكين الإعدادات العامة'];
            $notify[] = ['error', 'تم تعطيل إشعار البريد الإلكتروني الخاص بك'];
            return back()->withNotify($notify);
        }
    ...
    public function smsSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'تحديث إعدادات الرسائل القصيرة بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function smsTest(Request $request)
    {
        ...
        if ($general->sn == 1) {
            ...
            $sendSms->message = 'تحديث إعدادات الرسائل القصيرة بنجاح ' . $general->site_name;
            $sendSms->subject = ' ';
            $sendSms->send();
        } else {
            $notify[] = ['info', 'يرجى تمكين الإعدادات العامة'];
            $notify[] = ['error', 'تم تعطيل إخطار الرسائل القصيرة الخاصة بك'];
            return back()->withNotify($notify);
        }
