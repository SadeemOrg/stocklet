...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $notify[] = ['success', 'تم تحديث الإعداد العام بنجاح'];
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'تحديث تكوين النظام بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function logoIconUpdate(Request $request)
    {
        ...
        if ($request->hasFile('logo')) {
            try {
                ...
                $notify[] = ['error', 'لا يمكن تحميل الشعار'];
                return back()->withNotify($notify);
            }
        }
        ...
        if ($request->hasFile('favicon')) {
            try {
                ...
                $notify[] = ['error', 'لا يمكن تحميل favicon'];
                return back()->withNotify($notify);
            }
        }
        $notify[] = ['success', 'تم تحديث Logo & Favicon بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function customCssSubmit(Request $request)
    {
        ...
        $notify[] = ['success', 'تم تحديث CSS بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function maintenanceModeSubmit(Request $request)
    {
        ...
        $notify[] = ['success', 'تم تحديث وضع الصيانة بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function cookieSubmit(Request $request)
    {
        ...
        $cookie->save();
        $notify[] = ['success', 'يتم تحديث سياسة ملفات تعريف الارتباط بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function updateWaterMark(Request $request)
    {
        ...
        if ($request->hasFile('watermark')) {
            try {
                ...
                $notify[] = ['error', 'لا يمكن تحميل العلامة المائية'];
                return back()->withNotify($notify);
            }
        }

        $notify[] = ['success', 'تم تحديث العلامة المائية.'];
        return back()->withNotify($notify);
    }
    ...
    public function updateInstruction(Request $request)
    {
        ...
        if ($request->hasFile('txt')) {
            if ($request->txt->getClientOriginalExtension() != 'txt') {
                $notify[] = ['error', 'تم قبول ملف txt فقط'];
                return back()->withNotify($notify);
            }
            $filename = 'license.txt';
            $path   = 'assets/license/';

            if ($general->ins_file != null) {
                unlink($path . $general->ins_file);
            }
        ...
        $notify[] = ['success', 'فتم تحديث التعليمات بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function ftpSettingsUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'تحديث إعداد التخزين بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function updateSocialiteCredentialStatus($key)
    {
        ...
        $notify[] = ['success', 'تغيرت الحالة بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function updateSocialiteCredential(Request $request, $key)
    {
        ...
        $notify[] = ['success', ucfirst($key) . ' تم تحديث بيانات الاعتماد بنجاح'];
        return back()->withNotify($notify);
    }
}
