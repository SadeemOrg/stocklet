...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $pageTitle = 'تفاصيل المستخدم - ' . $user->username;
    ...
    public function update(Request $request, $id)
    {
        ...
        $notify[] = ['success', 'تم تحديث تفاصيل المستخدم بنجاح'];
    ...
    public function addSubBalance(Request $request, $id)
    {
        ...
        if ($request->act == 'add') {
            ...
            $notify[] = ['success', $general->cur_sym . $amount . ' اضيف بنجاح'];
        } else {
            if ($amount > $user->balance) {
                $notify[] = ['error', $user->username . ' لا يوجد توازن كافٍ.'];
                return back()->withNotify($notify);
            }
            ...
            $notify[] = ['success', $general->cur_sym . $amount . ' طرحت بنجاح'];
        }
    ...
    public function status(Request $request, $id)
    {
        ...
        if ($user->status == Status::USER_ACTIVE) {
            ...
            $notify[] = ['success', 'حظر المستخدم بنجاح'];
        } else {
            $user->status = Status::USER_ACTIVE;
            $user->ban_reason = null;
            $notify[] = ['success', 'المستخدم رفع حظر بنجاح'];
        }
        $user->save();
        return back()->withNotify($notify);
    }
    ...
    public function showNotificationSingleForm($id)
    {
        ...
        if (!$general->en && !$general->sn) {
            $notify[] = ['warning', 'يتم تعطيل خيارات الإخطار حاليًا'];
    ...
    public function sendNotificationSingle(Request $request, $id)
    {
        ...
        $notify[] = ['success', 'إرسال الإخطار بنجاح'];
        return back()->withNotify($notify);
    }
    ...
    public function updateFeaturedStatus($id)
    {
        ...
        $user->save();
        $notification = $user->is_featured ? 'المستخدم المميز بنجاح' : 'المستخدم غير المميز بنجاح';
